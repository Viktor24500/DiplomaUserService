...
namespace SystemUserService.DataAccess.Repositories.Intefaces
{
    public interface IPermissionsRepository
    {
        ...
        Task<Result<PermissionDTO>> UpdatePermission(int id, string name, string? description);
        Task<Result<PermissionDTO>> CreatePermission(string name, string? description);
